...
The projects you can choose from are a <a href="#kinetic">Kinetic Type Video</a>, a <a href="#title">Title Sequence</a>, or a <a href="#broadcast">Broadcast Design</a>,
...
### Projects
#### <span id="broadcast">Broadcast Design</span>
...
* Single video at 1920x1080 that includes all the specific parts with titles before each part
